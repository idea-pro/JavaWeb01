    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/JavaWeb/login.jsp" class="fir">您好，请登录</a></li>
                <li><a href="/JavaWeb/register.jsp">注册</a></li>
                <li>
                    <span></span>
                    <a href="#">消息</a>
                </li>
...
<div class="jumbotron yy_choice">
    ...
    <a href="/JavaWeb/login.jsp" class="sports"></a>
    <a href="/JavaWeb/login.jsp" class="study"></a>
